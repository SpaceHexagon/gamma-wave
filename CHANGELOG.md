...
* feat(media): Promisifies media server test set up and clean up (#1774) ([d72da37](https://github.com/meanjs/mean/commit/d72da37)), closes [#1773](https://github.com/meanjs/mean/issues/1773)
* feat(media): Simple test enhancement (#1659) ([44a569e](https://github.com/meanjs/mean/commit/44a569e)), closes [#1658](https://github.com/meanjs/mean/issues/1658)
...
* fix(media): add callback for remove media (#1534) ([a7aebbd](https://github.com/meanjs/mean/commit/a7aebbd)), closes [#1274](https://github.com/meanjs/mean/issues/1274)
* fix(media): Media controllers name conflicts (#1428) ([c96f8c0](https://github.com/meanjs/mean/commit/c96f8c0))
* fix(media): Media edit/delete validation ([69b8a05](https://github.com/meanjs/mean/commit/69b8a05)), closes [#1146](https://github.com/meanjs/mean/issues/1146)
* fix(media): Orphaned User reference throws server error ([2bdde4e](https://github.com/meanjs/mean/commit/2bdde4e)), closes [#1082](https://github.com/meanjs/mean/issues/1082)
...
* add bootstrap class 'unstyled' to remove bullet points in media list ([cb62e46](https://github.com/meanjs/mean/commit/cb62e46))
* add bootstrap class 'unstyled' to remove bullet points in media list ([b9d9b61](https://github.com/meanjs/mean/commit/b9d9b61))
...
* Added Media Delete Support ([eeb5423](https://github.com/meanjs/mean/commit/eeb5423))
...
* Adding karma-ng-html2js-preprocessor to fix karma tests.  Adding user mock to media tests. ([c468539](https://github.com/meanjs/mean/commit/c468539))
...
* adding proper handling for invalid model ObjectIds passed on to media routes ([5bccbdd](https://github.com/meanjs/mean/commit/5bccbdd))
...
* adding test to check proper handling when no media exists ([9952138](https://github.com/meanjs/mean/commit/9952138))
...
* Allow Guests to view Media ([cbebed9](https://github.com/meanjs/mean/commit/cbebed9))
...
* Media Cleanup ([c11c428](https://github.com/meanjs/mean/commit/c11c428))
* Media Example Fix ([ccf7eb3](https://github.com/meanjs/mean/commit/ccf7eb3))
* Media Example Fix ([6b0109e](https://github.com/meanjs/mean/commit/6b0109e))
* Media Example Fix ([6598c04](https://github.com/meanjs/mean/commit/6598c04))
* Media Example Fix ([23dc7a3](https://github.com/meanjs/mean/commit/23dc7a3))
...
* Clean up media example ([0b3dead](https://github.com/meanjs/mean/commit/0b3dead))
...
* Dummy config directory for the media module to make it easier for developers to understand and re ([903b4ca](https://github.com/meanjs/mean/commit/903b4ca))
...
* Fixing media and express 4 modification ([5ff49a7](https://github.com/meanjs/mean/commit/5ff49a7))
* Fixing media ([38f08ff](https://github.com/meanjs/mean/commit/38f08ff))
* Fixing Media Issues ([f132e10](https://github.com/meanjs/mean/commit/f132e10))
...
* fixing issue #348 - instead of returning a server error 500 on media loading which isnt found we'l ([56aff70](https://github.com/meanjs/mean/commit/56aff70))
...
* Fixing style, adding media test ([c42c8eb](https://github.com/meanjs/mean/commit/c42c8eb))
...
* Fixing user details exposure in media example ([0cfbafa](https://github.com/meanjs/mean/commit/0cfbafa))
...
* More Naming Fixes, media cleanup ([edd549d](https://github.com/meanjs/mean/commit/edd549d))
...
* Remove console.log from an media test ([a8dae99](https://github.com/meanjs/mean/commit/a8dae99))
...
* Remove ng-init directive from media list. ([7770ccc](https://github.com/meanjs/mean/commit/7770ccc))
...
* should return done(err) in media server route test ([d00f4ce](https://github.com/meanjs/mean/commit/d00f4ce))
...
* The media middleware was calling getErrorMessage with a null argument, causing a crash when this m ([71167b0](https://github.com/meanjs/mean/commit/71167b0))
...
* Update create-media.client.view.html ([3949400](https://github.com/meanjs/mean/commit/3949400))
...
* Update form-media.client.view.html ([7ffbd3f](https://github.com/meanjs/mean/commit/7ffbd3f))
...
* updated readme to make sure that people understand to open a browser on port 3045 in the end of the  ([41da378](https://github.com/meanjs/mean/commit/41da378)), closes [#5](https://github.com/meanjs/mean/issues/5)
* updated readme to make sure that people understand to open a browser on port 3045 in the end of the  ([928f40c](https://github.com/meanjs/mean/commit/928f40c)), closes [#5](https://github.com/meanjs/mean/issues/5)
...
* Use form validation in media ([e56c76a](https://github.com/meanjs/mean/commit/e56c76a))
...
* feat(media): Media Admin feature (#807) ([89075cb](https://github.com/meanjs/mean/commit/89075cb))
* feat(media): MediaService extended $resource (#1266) ([a7370a7](https://github.com/meanjs/mean/commit/a7370a7))
* feat(media): Modify media module to implement style guidelines. ([b3ad56e](https://github.com/meanjs/mean/commit/b3ad56e)), closes [#874](https://github.com/meanjs/mean/issues/874) [#339](https://github.com/meanjs/mean/issues/339)
* feat(media): Rename list.media.client.controller.js to list-media.client.controller.js ([a014ffc](https://github.com/meanjs/mean/commit/a014ffc)), closes [#1192](https://github.com/meanjs/mean/issues/1192)
...
* Merge pull request #890 from lirantal/feature/media-module-dummy-config-dir ([bd1a7d7](https://github.com/meanjs/mean/commit/bd1a7d7))
...
* Merge pull request #781 from codydaig/bug/listMediaAuth ([0be1b11](https://github.com/meanjs/mean/commit/0be1b11))
