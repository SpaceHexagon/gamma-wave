(function () {
  ...
  describe('Admin Media List Controller Tests', function () {
    // Initialize global variables
    var MediaAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _MediaService_) {
      ...
      $httpBackend.whenGET('/modules/media/client/views/list-media.client.view.html').respond(200, '');
      ...
      MediaAdminListController = $controller('MediaAdminListController as vm', {
        $scope: $scope
      });
